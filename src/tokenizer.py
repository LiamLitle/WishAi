...
class TokenizerBPE:
    ...
    def entrainer(self, texte, vocab_size=VOCAB_SIZE):
        ...
        """
        print(f"\n{'='*55}")
        print(f"  ENTRAÎNEMENT TOKENIZER BPE")
        print(f"{'='*55}")
    ...
    def sauvegarder(self, chemin=TOKENIZER_FILE):
...
if __name__ == "__main__":
    ...
    tok.sauvegarder(TOKENIZER_FILE)
    ...
    print(f"  Lance maintenant : python nanogpt_bpe.py")
    print("="*55)
